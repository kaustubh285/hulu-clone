...
function Nav({ setSelectedOption }) {
  return (
    <div className='nav'>
      ...
      <h2
        onClick={() => {
          setSelectedOption(requests.fetchAction);
        }}>
        Action
      </h2>
      <h2
        onClick={() => {
          setSelectedOption(requests.fetchComedy);
        }}>
        Comedy
      </h2>
      <h2
        onClick={() => {
          setSelectedOption(requests.fetchHorror);
        }}>
        Horror
      </h2>
      <h2
        onClick={() => {
          setSelectedOption(requests.fetchRomance);
        }}>
        Romance
      </h2>
      <h2
